...
public class Practice {
  ...
  //Where n represents the length of the input array matrix
  // Remember to define your variables!
  ...
  //Where n represents the size of the input int n
  // Remember to define your variables!
  ...
  // Time Complexity:O(n)
  // Space Complexity:O(n)
  // where n = total number of ints stored in all the lists in the map.
  // Remember to define your variables!
  ...
  // Time Complexity: O(n)
  // Space Complexity: O(n)
  //Where n represents the total number of characters across all strings
  // Remember to define your variables!
